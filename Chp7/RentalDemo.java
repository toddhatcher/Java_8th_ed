...
public class RentalDemo
{
	public static void main(String[] args)
	{
		...
		// Chp7
		String contactPhoneNumber = contactPhoneNumber();
        
		    // Invoke 1st object with user provided values
		    Rental firstRental = new Rental(contractNumber, contactPhoneNumber, rentalMinutes);
		...
		contactPhoneNumber = contactPhoneNumber();
		    ...
		    Rental secondRental = new Rental(contractNumber, contactPhoneNumber, rentalMinutes);
		...
		contactPhoneNumber = contactPhoneNumber();
		    ...
		    Rental thirdRental = new Rental(contractNumber, contactPhoneNumber, rentalMinutes);
